        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid auto-rows-fr gap-6 sm:grid-cols-2 xl:grid-cols-4">
            {filteredProducts.map((product) => (
              <div
                key={product.title}
                className="group flex h-full flex-col overflow-hidden rounded-[2rem] border border-[#FADADD] bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-xl"
              >
                <div className="p-4">
                  {product.image ? (
                    <img
        ...
        <div className="mx-auto grid max-w-7xl overflow-hidden rounded-[2.5rem] bg-[#4B2338] md:grid-cols-2">
          <div className="p-10 text-white md:p-14">
            ...
            <p className="mt-6 text-lg leading-8 text-[#FADADD]">
              Hubby Hub creates relationship resources with a soft but powerful
              purpose: helping readers think deeper, communicate better, and
              love with more intention.
            </p>
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-8 rounded-[2.5rem] border border-[#FADADD] bg-white p-8 shadow-sm md:grid-cols-[1fr_auto] md:p-12">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-lg leading-8 text-[#5c4a50]">
              Explore the book created to help women reconnect, communicate, and
              bring more attention back into love.
            </p>
          </div>
